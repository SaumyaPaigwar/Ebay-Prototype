...
//	================================= GET ALL PRODUCTS BASES ON LOGEDIN USER ID===================================//
	...
	@GET 
	@Path("/getallproductSellerInfo/{user_id}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Cart> getCartProductListSellerInfo(@PathParam("user_id") int user_id) {
		CartService C1 = new CartService();
		return C1.getCartProductListSellerInfo(user_id);
	}
